...
if __name__ == '__main__':
    wgan = WGAN()
    begin8=time.time()
    wgan.train(epochs=30000, batch_size=8, sample_interval=50)
    end8=time.time()
    begin16=time.time()
    wgan.train(epochs=30000, batch_size=16, sample_interval=50)
    end16=time.time()
    begin32=time.time()
    ...
    end64=time.time()
    begin128=time.time()
    wgan.train(epochs=30000, batch_size=128, sample_interval=50)
    end128=time.time()
    begin256= time.time()
    wgan.train(epochs=30000, batch_size=256, sample_interval=50)
    end256=time.time()
